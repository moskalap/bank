...
public interface PremiumAccountPrx extends AccountPrx
{
    ...
    {
        return _iceI_getForeignCurrencyCreditInfoAsync(amount, endOfContract, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CreditInfo> getForeignCurrencyCreditInfoAsync(Money amount, Date endOfContract, java.util.Map<String, String> context)
    {
        return _iceI_getForeignCurrencyCreditInfoAsync(amount, endOfContract, context, false);
    }
